...
//
        if (ActivityCompat.checkSelfPermission(FileSelectionActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED &&

                ActivityCompat.checkSelfPermission(FileSelectionActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void ok(){
        ...
        Log.d(TAG, "FilesWillBe: "+resultFileList.toString());
