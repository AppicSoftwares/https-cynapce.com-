...
import com.alcanzar.cynapse.activity.MedicalProfileInterface;
import com.alcanzar.cynapse.model.MedicalProfileModel;

import java.util.ArrayList;

public class MedicalProfileAdapter extends RecyclerView.Adapter<MedicalProfileAdapter.MyViewHolder> {
    Context mcontext;
    MedicalProfileInterface metroCityInterface;
    public static ArrayList<MedicalProfileModel> courselist = new ArrayList<>();
    private ArrayList<String> citylist = new ArrayList<>();
    private ArrayList<MedicalProfileInterface> mOriginalValues;
    int len = 0;

    public MedicalProfileAdapter(ArrayList<MedicalProfileModel> courselist, Context mcontext, MedicalProfileInterface metroCityInterface1) {
        ...
        holder.checkbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (courselist.get(pos).getStatus()) {
                    ...
                    // citylist.add(courselist.get(pos).getId());
                }
            }
        });
...
//
//    }
    private void notifyDataSetChanged(ArrayList<MedicalProfileModel> courselist) {
        this.courselist = courselist;
