...
public class TicketsPackageAdapter extends RecyclerView.Adapter<TicketsPackageAdapter.MyViewHolder> {
    ...
    public TicketsPackageAdapter(Context context, ArrayList<ConferencePackageModel> packageList, boolean flag) {
    ...
    @Override
    public void onBindViewHolder(TicketsPackageAdapter.MyViewHolder holder, int position) {
