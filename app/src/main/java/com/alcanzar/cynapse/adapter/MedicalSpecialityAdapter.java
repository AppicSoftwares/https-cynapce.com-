...
public class MedicalSpecialityAdapter extends RecyclerView.Adapter<MedicalSpecialityAdapter.MyViewHolder> implements Filterable {
    ...
    public MedicalSpecialityAdapter(ArrayList<JobSpecializationModel> courselist, Context mcontext, MedicalTitleInterface metroCityInterface1) {
...
//        });
        ...
        if (courselist.get(position).getStatus())
            isAllChked = true;
        else
            isAllChked = false;
