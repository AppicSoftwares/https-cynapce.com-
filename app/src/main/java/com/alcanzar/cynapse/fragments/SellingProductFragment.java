 ...
 */
public class SellingProductFragment extends Fragment {
    //TODO: layout views
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_selling_product, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        //TODO : for recycle view and listing purpose
...
//        arrayList = ((MyDealsActivity)getActivity()).handler.getSellBuyProducts(DatabaseHelper.TABLE_SELL_BUY_PRODUCT_MASTER, "1");
//        if(arrayList.size() == 0)
//        {
//            no_record_txt.setVisibility(View.VISIBLE);
//            no_record_txt.setText("No Selling Product Found");
//        }
//        else
//        {
...
//        {
//            no_record_txt.setVisibility(View.VISIBLE);
//            no_record_txt.setText("No Selling Products Found");
//        }
...
//                        recycleView.setAdapter(myDealsAdapter);
    ...
    public void setData()
    {
        ...
        if (arrayList.size() == 0) {
            ...
            no_record_txt.setVisibility(View.GONE);
            MyDealsAdapter myDealsAdapter = new MyDealsAdapter(getActivity(), R.layout.marketplacerow, arrayList, "3");
            recycleView.setAdapter(myDealsAdapter);
        }
    }
}
