...
import com.alcanzar.cynapse.api.PostJobListApi;
...
//        }
    ...
    private void PostJobListApi() throws JSONException {
        ...
        new PostJobListApi(getActivity(),header){
            @Override
                    ...
                    if(res_code.equals("1")){
                      //  MyToast.toastLong(getActivity(),res_msg);
                        ...
                        for(int i = 0;i<header2.length();i++){
                            ...
                            model.setSpecialization_id(item.getString("specilization_id"));
    ...
    public void setData()
    {
        arrayList = ((MyJobActivity)getActivity()).handler.getJobList(DatabaseHelper.TABLE_JOBS_MASTER, "2","1");

        if(arrayList.size() == 0)
        {
            no_record_txt.setVisibility(View.VISIBLE);
            no_record_txt.setText("No Posted Jobs Found");
        }
        ...
        else
        {
            ...
            RequestPostJobAdapter requestPostJobAdapter = new RequestPostJobAdapter(getContext(),R.layout.job_row,arrayList,"2");
