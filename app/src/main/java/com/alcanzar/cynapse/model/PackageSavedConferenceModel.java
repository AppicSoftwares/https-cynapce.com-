...
public class PackageSavedConferenceModel {
    ...
    public PackageSavedConferenceModel() {
    }

    public PackageSavedConferenceModel(String conference_pack_id, String conference_pack_day, String conference_pack_charge) {
