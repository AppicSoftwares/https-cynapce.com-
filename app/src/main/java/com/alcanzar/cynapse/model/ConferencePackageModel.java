...
public class ConferencePackageModel {
 ...
 private String isSelect="0";
    ...
    public ConferencePackageModel() {
    }

    public ConferencePackageModel(String conference_pack_id, String conference_pack_day, String conference_pack_charge) {
