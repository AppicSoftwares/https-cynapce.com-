...
public class AddForgeinPackageMYConferenceModel {
    ...
    public AddForgeinPackageMYConferenceModel() {
    }

    public AddForgeinPackageMYConferenceModel(String conference_pack_id, String conference_pack_day, String conference_pack_charge) {
